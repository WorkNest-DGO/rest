                ...
                <div class="navbar-nav ml-auto">
                    <a href="<?= BASE_URL ?>index.php" class="nav-item nav-link active">Inicio</a>
                        ...
                        <div class="dropdown-menu">
                            <a href="<?= BASE_URL ?>insumos/insumos.php" class="dropdown-item">Insumos</a>
                            <a href="<?= BASE_URL ?>inventario/inventario.php" class="dropdown-item">Inventario</a>
                            <a href="<?= BASE_URL ?>recetas/recetas.php" class="dropdown-item">Recetas</a>
                        </div>
                    </div>
                    <a href="<?= BASE_URL ?>cocina/cocina.php" class="nav-item nav-link">Cocina</a>
                    <a href="<?= BASE_URL ?>ventas/ventas.php" class="nav-item nav-link">Ventas</a>
                    <a href="<?= BASE_URL ?>corte_caja/corte.php" class="nav-item nav-link">Cortes</a>
                    <a href="<?= BASE_URL ?>repartidores/repartos.php" class="nav-item nav-link">Repartos</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="<?= BASE_URL ?>horarios/horarios.php" class="dropdown-item">Horarios</a>
                            <a href="<?= BASE_URL ?>ventas/ticket.php" class="dropdown-item">ticket</a>
                            <a href="<?= BASE_URL ?>reportes/reportes.php" class="dropdown-item">Reportes</a>
                        </div>
                    </div>
