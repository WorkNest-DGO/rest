...
<div class="page-header mb-0">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2>Catálogo de Tarjetas</h2>
      </div>
      <div class="col-12">
        <a href="../dash.php">Dashboard ADMIN</a>
        <a>Catálogo de Tarjetas</a>
      </div>
    </div>
  </div>
</div>
...
<div class="container mt-5 mb-5">
  ...
  <h1 class="section-header">Tarjetas</h1>

  <div class="mb-3 text-end">
    <button class="btn custom-btn" id="agregarTarjeta">Agregar tarjeta</button>
  </div>

  <div class="table-responsive">
    <table id="tablaTarjetas" class="styled-table">
      <thead>
        <tr>
          <th>ID</th>
          <th>Nombre</th>
      ...
      <form id="formAgregar">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="nombreTarjeta" class="form-control" required>
          </div>
        </div>
