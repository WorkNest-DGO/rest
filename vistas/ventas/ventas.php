      ...
      <form id="formVenta">
        ...
        <div id="seccionClienteDomicilio" class="form-group" style="display:none;">
          ...
          <div class="input-group mb-2">
            <input type="text" id="clienteBuscar" class="form-control" placeholder="Escribe nombre, teléfono o colonia" list="clienteOpciones" autocomplete="off">
            <datalist id="clienteOpciones"></datalist>
